...
@section('breadcrumb')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Komoditas Divisi</li>
        </ol>
    </div>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Tabel Data Komoditas Divisi</div>
            @can('komoditas-create')
            <button class="btn btn-success btn-rounded waves-effect waves-light btn-sm float-right mt-0" onclick="location.href='{{ route('kategori.create') }}'"><span class="btn-label"><i class="mdi mdi-file-plus"></i></span>Tambah Data</button>
            @endcan
                    ...
                    <table class="table table-hover table-striped table-bordered responsive" id="tblDivisi" width="100%">
                        <thead>
                            <tr>
                                ...
                                @can('komoditas-edit','komoditas-delete')
                                <th>Aksi</th>
                                @endcan
                            </tr>
                        </thead>
...
<script type="text/javascript">
    ...
    function draft(id){
        Swal.fire({
            title: 'Konfirmasi?',
            text: "Anda yakin akan menghapus data Komoditas ini ?",
            icon: 'warning',
