...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Form Tambah Jabatan</div>
            <div class="ribbon-content">
                <form role="form" id="frmBagian" method="POST" action="{{ route('jabatan.store') }}">
                    @csrf

                    <div class="form-group has-error">
                        <label for="exampleInputUsername2">Nama Jabatan <code>*</code></label>
                        <input type="text" class="form-control" id="nama_jabatan" name="nama_jabatan" value="{{ old('nama_jabatan') }}" autofocus required>
                    </div>
