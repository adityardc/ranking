...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Form Tambah Perusahaan</div>
            <div class="ribbon-content">
                <form role="form" id="frmBagian" method="POST" action="{{ route('ptpn.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-9 col-md-9">
                            <div class="form-group has-error">
                                ...
                                <input type="text" class="form-control" id="company" name="company" value="{{ old('company') }}" autofocus required>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                                <label for="exampleInputUsername2">Kode Perusahaan <code>*</code></label>
                                <input type="text" class="form-control" id="company_code" name="company_code" value="{{ old('company_code') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="row">
