...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Tabel Data Perusahaan</div>
            @can('perusahaan-create')
            <button class="btn btn-success btn-rounded waves-effect waves-light btn-sm float-right mt-0" onclick="location.href='{{ route('ptpn.create') }}'"><span class="btn-label"><i class="mdi mdi-file-plus"></i></span>Tambah Data</button>
            @endcan
                    ...
                    <table class="table table-hover table-striped table-bordered responsive" id="tblDivisi" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th>Alamat</th>
                                @can('perusahaan-edit','perusahaan-delete')
                                <th>Aksi</th>
                                @endcan
                            </tr>
                        </thead>
...
<script type="text/javascript">
    ...
    function draft(id){
        Swal.fire({
            title: 'Konfirmasi?',
            text: "Anda yakin akan menghapus data Perusahaan ini ?",
            icon: 'warning',
    ...
    $(document).ready(function(){
        ...
        var t = $('#tblDivisi').DataTable({
            ...
            "processing": true,
            "serverSide": true,
            "ajax": '{{ route('ptpn.data') }}',
            "columns": [
                { data: "id", width: "1%", className: "text-center", searchable: false, orderable: false },
                { data: "company", orderable: false },
                { data: "company_code", width: "15%", className: "text-center", orderable: false },
                { data: "address", width: "20%", orderable: false },
                @can('perusahaan-edit','perusahaan-delete')
