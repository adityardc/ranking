...
@section('breadcrumb')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Tambah Data Penilaian KPI</li>
        </ol>
    </div>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Form Tambah Penilaian KPI</div>
            <div class="ribbon-content">
                <form role="form" id="frmBagian" method="POST" action="{{ route('indikator.store') }}">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <button type='button' class='btn btn-success btn-xs waves-effect waves-light'><span><b>{{ $user_data->ptpn->company }}</b></span></button>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="exampleInputUsername2">Divisi</label><br>
                                <button type='button' class='btn btn-success btn-xs waves-effect waves-light'><span><b>{{ $user_data->divisi->nama_divisi }}</b></span></button>
                            </div>
                        </div>
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="exampleInputUsername2">Komoditas</label><br>
                                @foreach ($user_data->divisi->kategoridivisis as $val)
                                    <button type='button' class='btn btn-primary btn-xs waves-effect waves-light'><span><b>{{ $val->kategori->nama_kategori }}</b></span></button>
                                @endforeach
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-sm-2 col-md-2">
                            <div class="form-group">
                                ...
                                <button type='button' class='btn btn-danger btn-xs waves-effect waves-light' name="jml_karyawan" value="{{ $kry }}"><span><b>{{ $kry }}</b></span></button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-success" name="jml_karyawan" value="{{ $kry }}"><i class="fa fa-save"></i> SIMPAN</button>
