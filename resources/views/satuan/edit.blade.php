...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Form Ubah Data Satuan Indikator</div>
            <div class="ribbon-content">
                <form role="form" id="frmBagian" method="POST" action="{{ route('satuan.update', $satuan->id) }}">
                    @csrf
                    {{ method_field('PUT') }}

                    <div class="form-group has-error">
                        <label for="exampleInputUsername2">Kode Satuan <code>*</code></label>
                        <input type="text" class="form-control" id="kode_satuan" name="kode_satuan" value="{{ $satuan->kode_satuan }}" autofocus required>
                    </div>
                    <div class="form-group has-error">
                        <label for="exampleInputUsername2">Deskripsi <code>*</code></label>
                        <textarea name="deskripsi" id="deskripsi" cols="30" rows="5" class="form-control">{{ $satuan->deskripsi }}</textarea>
                    </div>
