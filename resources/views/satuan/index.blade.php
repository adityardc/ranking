...
@section('breadcrumb')
    <div class="page-title-right">
        <ol class="breadcrumb m-0">
            ...
            <li class="breadcrumb-item active">Satuan Indikator</li>
        </ol>
    </div>
@endsection
...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Tabel Data Satuan Indikator</div>
            @can('satuan-create')
            <button class="btn btn-success btn-rounded waves-effect waves-light btn-sm float-right mt-0" onclick="location.href='{{ route('satuan.create') }}'"><span class="btn-label"><i class="mdi mdi-file-plus"></i></span>Tambah Data</button>
            @endcan
...
<script type="text/javascript">
    ...
    function draft(id){
        Swal.fire({
            title: 'Konfirmasi?',
            text: "Anda yakin akan menghapus data Satuan ini ?",
            icon: 'warning',
    ...
    $(document).ready(function(){
        ...
        var t = $('#tblDivisi').DataTable({
            ...
            "columns": [
                ...
                { data: "kode_satuan", width: "20%", orderable: false },
                { data: "deskripsi" },
                @can('satuan-edit','satuan-delete')
