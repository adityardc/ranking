...
<div class="row">
    <div class="col-lg-12">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Tabel Data Divisi</div>
            @can('divisi-create')
            <button class="btn btn-success btn-rounded waves-effect waves-light btn-sm float-right mt-0" onclick="location.href='{{ route('divisi.create') }}'"><span class="btn-label"><i class="mdi mdi-file-plus"></i></span>Tambah Data</button>
            @endcan
...
<script type="text/javascript">
    ...
    function draft(id){
        Swal.fire({
            title: 'Konfirmasi?',
            text: "Anda yakin akan menghapus data Divisi ini ?",
            icon: 'warning',
    ...
    $(document).ready(function(){
        ...
        var t = $('#tblDivisi').DataTable({
            ...
            "columns": [
                ...
                { data: "kode_divisi", width: "10%", className: "text-center", orderable: false },
                { data: "ptpn.company", width: "20%", orderable: false },
                { data: "kat", width: "20%", orderable: false,
