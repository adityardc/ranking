...
<div class="row">
    <div class="col-lg-6">
        <div class="card-box ribbon-box">
            <div class="ribbon ribbon-blue float-left"><i class="mdi mdi-access-point mr-1"></i> Form Tambah Divisi</div>
            <div class="ribbon-content">
                <form role="form" id="frmBagian" method="POST" action="{{ route('divisi.store') }}">
                    @csrf
                    <div class="row">
                        <div class="col-sm-9 col-md-9">
                            <div class="form-group has-error">
                                <label for="exampleInputUsername2">Nama Divisi <code>*</code></label>
                                <input type="text" class="form-control" id="nama_divisi" name="nama_divisi" value="{{ old('nama_divisi') }}" autofocus required>
                            </div>
                        </div>
                        <div class="col-sm-3 col-md-3">
                            <div class="form-group">
                                <label for="exampleInputUsername2">Kode Divisi <code>*</code></label>
                                <input type="text" class="form-control" id="kode_divisi" name="kode_divisi" value="{{ old('kode_divisi') }}" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
